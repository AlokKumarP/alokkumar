...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_itdw46d', 'template_kqinrz8', form.current, 'GaLNgjOkKdsOWzKJ2')
        e.target.reset()
  };
    return(
                ...
                <div className="contact__contact">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://m.me/crupticalcoder" className="contact__button">Write Me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                    </div>
                </div>
